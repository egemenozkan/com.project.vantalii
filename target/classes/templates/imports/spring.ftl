...
<#macro formRadioButtons path options separator attributes="">
    ...
    <input type="radio" id="com.project:web:war:alfa" name="${status.expression}" value="${value}"<#if stringStatusValue == value> checked="checked"</#if> ${attributes?no_esc}<@closeTag/>
    <label for="com.project:web:war:alfa">${options[value]}</label>${separator?no_esc}
    </#list>
</#macro>
...
<#macro formCheckboxes path options separator attributes="">
    ...
    <#assign id="${status.expression?replace('[','')?replace(']','')}${value_index}">
    <#assign isSelected = contains(status.actualValue?default([""]), value)>
    <input type="checkbox" id="com.project:web:war:alfa" name="${status.expression}" value="${value}"<#if isSelected> checked="checked"</#if> ${attributes?no_esc}<@closeTag/>
    <label for="com.project:web:war:alfa">${options[value]}</label>${separator?no_esc}
    </#list>
...
<#macro formCheckbox path attributes="">
    ...
    <input type="hidden" name="_${status.expression}" value="on"/>
    <input type="checkbox" id="com.project:web:war:alfa" name="${status.expression}"<#if isSelected> checked="checked"</#if> ${attributes?no_esc}/>
</#macro>
