...
<!doctype html>
<html lang="${ webPage.language.code?lower_case }"  class="page places category" data-language="${ webPage.language }" data-user-id="<#if (user??)>${ user.id! }<#else>0</#if>" data-place-id="${ pageId!0 }">
   <head>
