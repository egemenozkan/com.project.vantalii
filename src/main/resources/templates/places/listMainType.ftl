...
<#assign description> <@spring.message "description.places.mainType.${ mainType }" /></#assign>
...
<head>
    ...
    <link href="https://www.vantalii.com/tr/places/m/${ slug! }" hreflang="tr" rel="alternate">
    <link href="https://www.vantalii.com/en/places/m/${ slug! }" hreflang="en" rel="alternate">
    <link href="https://www.vantalii.ru/places/m/${ slug! }" hreflang="ru" rel="alternate">
