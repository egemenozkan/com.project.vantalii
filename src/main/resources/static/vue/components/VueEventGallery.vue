...
console.log(this.file.size);
      ...
      formData.append("pageId", this.usePlaceImages ? this.placeId : this.eventId);
      const postUrl = self.usePlaceImages ? "/places/file-upload/single" : "/events/file-upload/single";
  ...
  computed: {
    ...
    usePlaceImages: function() {
      console.log("->", document
        .getElementsByTagName("html")[0]
        .getAttribute("data-use-place-images"), document
        .getElementsByTagName("html")[0]
        .getAttribute("data-use-place-images") === "true");
      return document
        .getElementsByTagName("html")[0]
        .getAttribute("data-use-place-images") === "true";
    }    
