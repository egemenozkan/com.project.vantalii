...
import com.project.web.social.MyUsersConnectionRepository;
...
//	private DataSource dataSource;
	...
	public void addConnectionFactories(ConnectionFactoryConfigurer connectionFactoryConfigurer, Environment environment) {
		connectionFactoryConfigurer.addConnectionFactory(new FacebookConnectionFactory(environment.getProperty("spring.social.github.appId"),
...
//				Encryptors.noOpText());
		...
		UsersConnectionRepository repository = new MyUsersConnectionRepository();
